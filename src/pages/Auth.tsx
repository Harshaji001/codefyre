...
const Auth = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{isLogin ? "Sign In" : "Sign Up"} - CodeFyre</title>
        <meta name="description" content="Access your CodeFyre client dashboard" />
      </Helmet>
        ...
        <div className="relative z-10 w-full max-w-md px-4">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gradient mb-2">CodeFyre</h1>
